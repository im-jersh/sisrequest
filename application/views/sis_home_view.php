...
<div id="site-container">
    ...
    <div id="marquee-container">
        ...
        <div id="marquee-employee-info" class="column-right">
            ...
            <?php echo form_open('landing_page/validateForm', array('name'=>'requestForEmployee', 'id'=>'SISrequestForm', 'role'=>'form', 'style'=>'display:visible')); ?>
...
<!-- Modal -->
<div id="reviewRequest" class="modal fade" role="dialog">
            ...
            <div id="formReview" class="modal-body">
                <div>
                    ...
                    <div id="academicCareersReview">
                        <div id="careerCheckboxes" class="checkbox">
                            <label for="UGRD"><input name="UGRD" type="checkbox" id="UGRD" value="1" disabled>UGRD</label>
                            <label for="GRAD"><input name="GRAD" type="checkbox" id="GRAD" value="1" disabled>GRAD</label>
                            <label for="MED"><input name="MED" type="checkbox" id="MED" value="1" disabled>MED</label>
                            <label for="VET_MED"><input name="VET_MED" type="checkbox" id="VET_MED" value="1" disabled>VET MED</label>
                            <label for="LAW"><input name="LAW" type="checkbox" id="LAW" value="1" disabled>LAW</label>
                        </div>
                    </div>
                </div>
                <div id="reviewBoxes">
